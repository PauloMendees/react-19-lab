...
import * as devicePreference from '@/utils/device-preferences';
import { getAuthorizedDevices, getDeviceId, requestPermissions } from '@/utils/media-devices';
...
const MediaDevicesContext = createContext<MediaDevicesContextType>({} as MediaDevicesContextType);
